...
function checkSketch() {
    ...
    if(timer_check=="completed"||answer_holder=="correct"){
        timer_check="";
        answer_holder="";
        updateCanvas();
    }
...
function getResult(error, result){
    ...
    document.getElementById("label").innerHTML="Your Sketch is " + drawn_sketch;
    document.getElementById("confidence").innerHTML="Confidence is" + Math.round(result[0].confidence*100)+"%";
}